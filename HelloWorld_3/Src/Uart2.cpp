...
//Default ctor
stm32f767::Usart::Uart2::Uart2() {
  this->m_handle.Instance = USART2;
...
stm32f767::Usart::Uart2::Uart2(Settings& settings) {
...
bool stm32f767::Usart::Uart2::Initialize() {
  bool retval = true;
...
bool stm32f767::Usart::Uart2::Transmit(const char * buffer,
                                       const uint32_t len) {
